...
# Function letting buttons register events when clicked
...
# Generates the caption below question 
...
# Function to ask user questions for memory test
...
def print_results(total_correct_answers, total_time):
    myhtml30 = HTML("<h2>Well done! You have completed the test! (:</h2>")
    display(myhtml30)
...
# Displays information at the beginning of the test 
...
form_url = "https://forms.gle/xhvWaedffCrMgAUB8"


# Create data_dict and append user information
data_dict = {
    "User ID": user_id,
    "Age": age,
    "Gender": gender,
